...
# NEW: FORCED HTTPS IF SSL CERTIFICATE

SECURE_SSL_REDIRECT = False  # TRUE IF WE GET A CERTIFCATE, OTHERWISE REDIRECTS BREAK LOCALHOST
SECURE_HSTS_INCLUDE_SUBDOMAINS = True
SECURE_HSTS_PRELOAD = True
SECURE_HSTS_SECONDS = 31536000 if not DEBUG else 31536000 #AS WE DO NOT HAVE A CERTIFICATE, LET'S JUST SAY THAT THE APP IS TRUE
